...
async def run_one_cycle_subprocess():
    """Один цикл парсера в отдельном процессе; по таймауту процесс завершается извне."""
...
async def cron():
    """Бесконечный цикл: снова spawn парсера после завершения или kill по таймауту."""
    cycle_number = 0
